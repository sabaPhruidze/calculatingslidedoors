...
type FiveProps = { onTotalsChange?: (t: Totals) => void };

const Five: React.FC<FiveProps> = ({ onTotalsChange }) => {
  ...
  // Same formulas/structure as fourth.tsx
  const getResults = (c: { x: string; y: string; quantity: string }) => {
    ...
    const gr = x * 9 + y * 3; // customize if needed
    const kv = x * y;
        ...
        return (
          <div key={c.id} className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-lg">გამოთვლა {i + 1} (Five)</h3>
