...
type SevenProps = { onTotalsChange?: (t: Totals) => void };

const Seven: React.FC<SevenProps> = ({ onTotalsChange }) => {
  ...
  // Same model as Six: z behaves like another dimension alongside x/y
  const getResults = (c: {
    x: string;
    z: string;
    y: string;
        ...
        return (
          <div key={c.id} className="mb-8">
            ...
            <div className="flex gap-4 mb-6">
              ...
              <div className="flex flex-col items-center">
                <Image
                  src="/4.png" // same as Six; change if you want
                  alt="Image"
                  width={500}
                  height={300}
                  priority
