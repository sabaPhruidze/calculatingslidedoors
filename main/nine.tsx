...
type NineProps = { onTotalsChange?: (t: Totals) => void };

const Nine: React.FC<NineProps> = ({ onTotalsChange }) => {
        ...
        return (
          <div key={c.id} className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-lg">გამოთვლა {i + 1} (Nine)</h3>
            ...
            <div className="flex gap-4 mb-6">
              ...
              <div className="flex flex-col items-center">
                <Image
                  src="/8.png" // match Six/Eight style (change if you want)
                  alt="Image"
                  width={500}
                  height={300}
                  priority
