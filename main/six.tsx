...
type SixProps = { onTotalsChange?: (t: Totals) => void };

const Six: React.FC<SixProps> = ({ onTotalsChange }) => {
  ...
  // Same model as First, but z acts exactly like x (added to x in formulas)
  const getResults = (c: {
    x: string;
    z: string;
    y: string;
    ...
    // Treat z like another x:
    const xz = x + z;
    const gr = x * 3 + z * 2 + y * 4;
    const kv = x * y;
    const mek = quantity;
        ...
        return (
          <div key={c.id} className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-lg">გამოთვლა {i + 1} (Six)</h3>
            ...
            <div className="flex gap-4 mb-6">
              ...
              <div className="flex flex-col items-center">
                <Image
                  src="/3.png" // change if you want a different image
                  alt="Image"
                  width={500}
                  height={300}
                  priority
